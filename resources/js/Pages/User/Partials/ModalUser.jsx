...
export default function ModalUser({ showModel, submit, isDelete, data, setData, errors, processing, onClick }) {
    return (
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                value={data.email}
                                className="mt-1 block w-full"
                                onChange={(e) => setData({ field: 'email', value: e.target.value })}
                            />
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                value={data.password}
                                className="mt-1 block w-full"
                                onChange={(e) => setData({ field: 'password', value: e.target.value })}
                            />
